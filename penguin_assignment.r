...
Gentoo_histogram <- plot_Gentoo_figure(Gentoo_sex_mass) + theme(plot.title = element_text(size = 18, hjust = 0.5))
...
save_Gentoo_plot_png(Gentoo_histogram, "figures/Gentoo_sex_mass_powerpoint.png", 
